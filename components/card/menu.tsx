...
import { Edit, LinkIcon, RotateCcw, Trash, Trash2 } from 'lucide-react';
...
export default function CardMenu({ data }: CardMenuProps) {
  ...
  return (
    <div className="pr-2">
      <DropdownMenu>
        <DropdownMenuTrigger className="cursor-pointer h-9 w-9 mt-1 flex items-center justify-center rounded-full hover:bg-neutral-200 dark:hover:bg-accent outline-none focus:border-none focus:outline-none active:bg-neutral-200 shrink-0">
          <MoreIcon className="fill-neutral-600 dark:fill-neutral-100 h-4 w-4 " />
        </DropdownMenuTrigger>
        <DropdownMenuContent className="mr-2 min-w-40">
          ...
          <DropdownMenuItem
            ...
            className="!text-red-600 !focus:bg-red-100 !active:bg-red-100 !dark:text-red-700 dark:hover:bg-red-200 dark:focus:bg-red-200 dark:active:bg-red-200"
          >
